...
## System Overview
The ICARA/MiFIDPRU Risk Intelligence Platform is a comprehensive regulatory capital management system designed as a modern, scalable, cloud-native application. The architecture prioritizes modularity, performance, security, and user experience.
...
- **User Domain**: Authentication, authorization, SMCR
